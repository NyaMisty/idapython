...
class uint64vec_t(object):
    ...
    def pop_back(self, *args) -> "void":
        ...
        pop_back(self)
        """
        return _ida_pro.uint64vec_t_pop_back(self, *args)

    def size(self, *args) -> "size_t":
        r"""
        size(self) -> size_t
        """
        return _ida_pro.uint64vec_t_size(self, *args)

    def empty(self, *args) -> "bool":
        r"""
        empty(self) -> bool
        """
        return _ida_pro.uint64vec_t_empty(self, *args)
    ...
    def at(self, *args) -> "unsigned long long const &":
        ...
        @param _idx: size_t
        """
        return _ida_pro.uint64vec_t_at(self, *args)

    def qclear(self, *args) -> "void":
        r"""
        qclear(self)
        """
        return _ida_pro.uint64vec_t_qclear(self, *args)

    def clear(self, *args) -> "void":
        r"""
        clear(self)
        """
        return _ida_pro.uint64vec_t_clear(self, *args)
    ...
    def capacity(self, *args) -> "size_t":
        ...
        capacity(self) -> size_t
        """
        return _ida_pro.uint64vec_t_capacity(self, *args)
    ...
    def reserve(self, *args) -> "void":
        ...
        @param cnt: size_t
        """
        return _ida_pro.uint64vec_t_reserve(self, *args)

    def truncate(self, *args) -> "void":
        r"""
        truncate(self)
        """
        return _ida_pro.uint64vec_t_truncate(self, *args)
    ...
    def swap(self, *args) -> "void":
        ...
        """
        return _ida_pro.uint64vec_t_swap(self, *args)

    def extract(self, *args) -> "unsigned long long *":
        r"""
        extract(self) -> unsigned long long *
        """
        return _ida_pro.uint64vec_t_extract(self, *args)
    ...
    def inject(self, *args) -> "void":
        ...
        @param len: size_t
        """
        return _ida_pro.uint64vec_t_inject(self, *args)
    ...
    def __eq__(self, *args) -> "bool":
        ...
        """
        return _ida_pro.uint64vec_t___eq__(self, *args)
    ...
    def __ne__(self, *args) -> "bool":
        ...
        @param r: qvector< unsigned long long > const &
        """
        return _ida_pro.uint64vec_t___ne__(self, *args)
    ...
    def insert(self, *args) -> "qvector< unsigned long long >::iterator":
        ...
        @param x: unsigned long long const &
        """
        return _ida_pro.uint64vec_t_insert(self, *args)
    ...
    def has(self, *args) -> "bool":
        ...
        @param x: unsigned long long const &
        """
        return _ida_pro.uint64vec_t_has(self, *args)
    ...
    def add_unique(self, *args) -> "bool":
        ...
        @param x: unsigned long long const &
        """
        return _ida_pro.uint64vec_t_add_unique(self, *args)
    ...
    def _del(self, *args) -> "bool":
        ...
        """
        return _ida_pro.uint64vec_t__del(self, *args)

    def __len__(self, *args) -> "size_t":
        r"""
        __len__(self) -> size_t
        """
        return _ida_pro.uint64vec_t___len__(self, *args)
    ...
    def __getitem__(self, *args) -> "unsigned long long const &":
        ...
        @param i: size_t
        """
        return _ida_pro.uint64vec_t___getitem__(self, *args)
    ...
    def __setitem__(self, *args) -> "void":
        ...
        """
        return _ida_pro.uint64vec_t___setitem__(self, *args)
