...
def find_free_chunk(*args) -> "ea_t":
    ...
    """
    return _ida_bytes.find_free_chunk(*args)
...
def get_item_refinfo(*args) -> "bool":
    ...
    @return: success
    """
    return _ida_bytes.get_item_refinfo(*args)
...
class octet_generator_t(object):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    value = property(_ida_bytes.octet_generator_t_value_get, _ida_bytes.octet_generator_t_value_set, doc=r"""value""")
    ea = property(_ida_bytes.octet_generator_t_ea_get, _ida_bytes.octet_generator_t_ea_set, doc=r"""ea""")
    avail_bits = property(_ida_bytes.octet_generator_t_avail_bits_get, _ida_bytes.octet_generator_t_avail_bits_set, doc=r"""avail_bits""")
    high_byte_first = property(_ida_bytes.octet_generator_t_high_byte_first_get, _ida_bytes.octet_generator_t_high_byte_first_set, doc=r"""high_byte_first""")
    ...
    def __init__(self, *args):
        ...
        @param _ea: ea_t
        """
        _ida_bytes.octet_generator_t_swiginit(self, _ida_bytes.new_octet_generator_t(*args))

    def invert_byte_order(self, *args) -> "void":
        r"""
        invert_byte_order(self)
        """
        return _ida_bytes.octet_generator_t_invert_byte_order(self, *args)
...
def get_octet2(*args) -> "uchar *":
    ...
    """
    return _ida_bytes.get_octet2(*args)
...
def get_operand_type_shift(*args) -> "int":
    ...
    """
    return _ida_bytes.get_operand_type_shift(*args)
...
def get_operand_flag(*args) -> "flags64_t":
    ...
    @return: the shift to the nibble
    """
    return _ida_bytes.get_operand_flag(*args)
...
def is_flag_for_operand(*args) -> "bool":
    ...
    @return: success
    """
    return _ida_bytes.is_flag_for_operand(*args)
...
def op_based_stroff(*args) -> "bool":
    ...
    @return: success
    """
    return _ida_bytes.op_based_stroff(*args)
...
def combine_flags(*args) -> "flags64_t":
    ...
    @param F: flags64_t
    """
    return _ida_bytes.combine_flags(*args)
...
def get_possible_item_varsize(*args) -> "asize_t":
    ...
    """
    return _ida_bytes.get_possible_item_varsize(*args)
