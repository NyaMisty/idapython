...
class idainfo(object):
    ...
    def _get_lflags(self, *args) -> "uint32":
        ...
        return _ida_ida.idainfo__get_lflags(self, *args)

    def _set_lflags(self, *args) -> "void":
        r"""
        _set_lflags(self, _f)
        ...
        """
        return _ida_ida.idainfo__set_lflags(self, *args)
...
def inf_set_app_bitness(*args) -> "void":
    ...
    @param bitness: uint
    """
    return _ida_ida.inf_set_app_bitness(*args)
...
def inf_merge_strlits(*args) -> "bool":
    ...
    """
    return _ida_ida.inf_merge_strlits(*args)
...
def inf_set_merge_strlits(*args) -> "bool":
    ...
    @param _v: bool
    """
    return _ida_ida.inf_set_merge_strlits(*args)
...
def is_database_busy(*args) -> "bool":
    ...
    """
    return _ida_ida.is_database_busy(*args)
...
def validate_idb(*args) -> "size_t":
    ...
    """
    return _ida_ida.validate_idb(*args)
...
def move_privrange(*args) -> "bool":
    ...
    @return: success
    """
    return _ida_ida.move_privrange(*args)
