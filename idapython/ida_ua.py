...
class op_t(object):
    ...
    def __get_value64__(self, *args) -> "uint64":
        ...
        """
        return _ida_ua.op_t___get_value64__(self, *args)

    def __set_value64__(self, *args) -> "void":
        r"""
        __set_value64__(self, v)

        @param v: uint64
        """
        return _ida_ua.op_t___set_value64__(self, *args)
...
class outctx_base_t(object):
    ...
    F32 = property(_ida_ua.outctx_base_t_F32_get, _ida_ua.outctx_base_t_F32_set, doc=r"""F32""")
    ...
    def getF(self, *args) -> "flags64_t":
        ...
        getF(self) -> flags64_t
        """
        return _ida_ua.outctx_base_t_getF(self, *args)
...
class outctx_t(outctx_base_t):
    ...
    prefix_ea = property(_ida_ua.outctx_t_prefix_ea_get, _ida_ua.outctx_t_prefix_ea_set, doc=r"""prefix_ea""")
    next_line_ea = property(_ida_ua.outctx_t_next_line_ea_get, _ida_ua.outctx_t_next_line_ea_set, doc=r"""next_line_ea""")
    ...
    def term_outctx(self, *args) -> "int":
        ...
        @return: the number of generated lines.
        """
        return _ida_ua.outctx_t_term_outctx(self, *args)
    ...
    def out_btoa(self, *args) -> "void":
        ...
        @param radix: (C++: char)
        """
        return _ida_ua.outctx_t_out_btoa(self, *args)
    ...
    def out_fcref_names(self, *args) -> "void":
        ...
        """
        return _ida_ua.outctx_t_out_fcref_names(self, *args)
