...
def unsync_and_delete_struc(*args) -> "void":
    ...
    """
    return _ida_struct.unsync_and_delete_struc(*args)
...
class udm_visitor_t(object):
    ...
    def visit_udm(self, *args) -> "int":
        ...
        """
        return _ida_struct.udm_visitor_t_visit_udm(self, *args)
    __swig_destroy__ = _ida_struct.delete_udm_visitor_t
    ...
    def __init__(self, *args):
        ...
        if self.__class__ == udm_visitor_t:
            ...
            _self = self
        _ida_struct.udm_visitor_t_swiginit(self, _ida_struct.new_udm_visitor_t(_self, *args))
    def __disown__(self):
        self.this.disown()
        _ida_struct.disown_udm_visitor_t(self)
        return weakref.proxy(self)

# Register udm_visitor_t in _ida_struct:
_ida_struct.udm_visitor_t_swigregister(udm_visitor_t)
...
def visit_stroff_udms(*args) -> "adiff_t *":
    ...
    """
    return _ida_struct.visit_stroff_udms(*args)
